...
class PenitipanHewan:
    ...
    def cari_hewan(penitipan, nama_hewan):
        current = penitipan.data_penitipan.head
        while current:
            if current.data['nama hewan'] == nama_hewan:
                return current
            current = current.next
        return None
    ...
    while True:
        ...
        if pilihan == '1':
            ...
            if jenis_pencarian == '1':
                nama = input("Masukkan nama pemilik yang ingin dicari: ")
                pemilik = PenitipanHewan.cari_pemilik(penitipan, nama)
                if pemilik:
                    print("===========================================================")
                    print("|                    DATA PENITIPAN                      |")
                    print("===========================================================")
                    print(" Nama Pemilik    : ", pemilik.data['nama'])
                    print(" Nomor HP        : ", pemilik.data['no hp'])
                    print(" Alamat          : ", pemilik.data['alamat'])
                    print(" Jenis Hewan     : ", pemilik.data['jenis hewan'])
                    print(" Nama Hewan      : ", pemilik.data['nama hewan'])
                    print(" Tanggal Penitipan: ", pemilik.data['tanggal penitipan'])
                    print("===========================================================")
                else:
                    print("===========================================================")
                    print("         DATA PENITIPAN HEWAN TIDAK DITEMUKAN.             ")
                    print("                      ( • ᴖ • ｡)                           ")
                    print("===========================================================")
            elif jenis_pencarian == '2':
                nama_hewan = input("Masukkan nama hewan yang ingin dicari: ")
                hewan = PenitipanHewan.cari_hewan(penitipan, nama_hewan)
                if hewan:
                    print("===========================================================")
                    print("|                    DATA PENITIPAN                       |")
                    print("===========================================================")
                    print(" Nama Pemilik    : ", hewan.data['nama'])
                    print(" Nomor HP        : ", hewan.data['no hp'])
                    print(" Alamat          : ", hewan.data['alamat'])
                    print(" Jenis Hewan     : ", hewan.data['jenis hewan'])
                    print(" Nama Hewan      : ", hewan.data['nama hewan'])
                    print(" Tanggal Penitipan: ", hewan.data['tanggal penitipan'])
                    print("===========================================================")
                else:
                    print("===========================================================")
                    print("         DATA PENITIPAN HEWAN TIDAK DITEMUKAN.            ")
